...
const Startfreetrail = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setLoading(false);
      if (err.response && err.response.data && err.response.data.message.includes('E11000')) {
  ...
  return (
    <div className="Container">
      <div className={styles.SignupBox}>
        <h1 className={styles.signUp}>Start a Free Trail</h1>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className={styles.formGroup}>
            <input
              ...
              required
            />
            <label className={styles.inputLabel} htmlFor="repeat-password">Repeat Password</label>
          </div>
